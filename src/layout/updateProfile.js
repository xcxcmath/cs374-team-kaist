...
export default function UpdateProfile(props) {
    ...
    return <div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', width: '92%', marginLeft: 'auto', marginRight: 'auto', marginTop: '10px'}}><TextField disabled id="name" label="Name" type="" defaultValue={name}/></div>
